...
\node [] at (16.5,5) {
	\includegraphics[width=80mm,height=60mm]{images/fig-S-dS-in.pdf}
};

\node [] at (16.5,-2.25) {
	\includegraphics[width=80mm,height=60mm]{images/fig-S-dS-out.pdf}
};
...
\node [] at (2,5) {
	\includegraphics[width=60mm]{images/fig-Sch-in.pdf}
};

\node [] at (2,-2.25) {
	\includegraphics[width=60mm]{images/fig-Sch-out.pdf}
};
...
\node [] at (8.5,5) {
	\includegraphics[width=60mm]{images/fig-S-AdS-in.pdf}
};

\node [] at (8.5,-2.25) {
	\includegraphics[width=60mm]{images/fig-S-AdS-out.pdf}
};

\node [fill=white] at (10,3) {
	\includegraphics[width=30mm]{images/fig-Bim-S-AdS-in.pdf}
};
...
\node [] at (-17.5,5) {
	\includegraphics[width=60mm]{images/fig-Minkowski-in.pdf}
};

\node [] at (-17.5,-2.25) {
	\includegraphics[width=60mm]{images/fig-Minkowski-out.pdf}
};
...
\node [] at (-11,5) {
	\includegraphics[width=60mm]{images/fig-AdS-in.pdf}
};

\node [] at (-11,-2.25) {
	\includegraphics[width=60mm]{images/fig-AdS-out.pdf}
};
...
\node [] at (-4.5,5) {
	\includegraphics[width=60mm]{images/fig-dS-in.pdf}
};

\node [] at (-4.5,-2.25) {
	\includegraphics[width=60mm]{images/fig-dS-out.pdf}
};
